...
const DO: Command[] = [
  ...
  {
    id: "do.competitor.simulate",
    group: "do",
    label: "Simulate a competitive move",
    aliases: ["battle sim", "what if"],
    hint: "Open the AI Battle Simulator for the current competitor",
    icon: Swords,
    action: "competitor:simulate",
    weight: 57,
  },
  {
    id: "do.competitor.attack",
    group: "do",
    label: "Attack a prompt they win",
    aliases: ["attack prompt", "queue attack"],
    hint: "Open Prompt Dominance and queue an attack",
    icon: Target,
    action: "competitor:open-prompts",
    weight: 56,
  },
  {
    id: "go.competitor.battle-plan",
    group: "go",
    label: "Battle Plan (current competitor)",
    aliases: ["battle plan", "kanban competitor"],
    hint: "Jump to the Battle Plan tab of the competitor you're viewing",
    icon: Flag,
    action: "competitor:open-battle-plan",
    weight: 54,
  },
  {
    id: "do.engine.compare",
    group: "do",
    label: "Compare engines",
    aliases: ["engine comparison", "vs engines"],
    hint: "Compare this engine's mention rate against sibling engines",
    icon: BarChart3,
    action: "engine:compare",
    weight: 56,
  },
  {
    id: "do.engine.strategy",
    group: "do",
    label: "Generate engine optimization",
    aliases: ["engine strategy", "optimize for engine", "tune"],
    hint: "Open the Optimization Strategy Generator for this engine",
    icon: Wand2,
    action: "engine:strategy",
    weight: 55,
  },
  {
    id: "go.engine.change-log",
    group: "go",
    label: "Engine change log",
    aliases: ["ai change log", "model changes"],
    hint: "Jump to the Model Changes tab for the engine you're viewing",
    icon: Activity,
    action: "engine:go-change-log",
    weight: 52,
  },
  {
    id: "go.engine-matrix",
    group: "go",
    label: "Engine × Competitor matrix",
    aliases: ["matrix", "grid", "cross tab", "share of voice matrix"],
    hint: "Which competitor wins on which engine — the crossroads view",
    icon: LayoutList,
    href: "/engine-matrix",
    brandScoped: true,
    weight: 68,
