...
export default async function ReportsPage() {
  ...
  // Portfolio view: compute a quick visibility score for EVERY brand this
  // org manages, not just the selected one — this is the "aggregate
  // portfolio visibility" view from 05-ui-ux-design-system.md, Screen G,
  // which only became buildable after Batch 16's multi-brand support.
  ...
  return (
    <div>
      ...
      {allBrands.length > 1 && (
        <Panel title="Portfolio visibility" description="Aggregate visibility score across every brand you manage." bodyClassName="overflow-x-auto p-0">
