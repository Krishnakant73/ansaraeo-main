// ============================================================
// Dashboard → Intelligence  (the brand's Bloomberg-terminal view)
//
...
export default async function IntelligencePage() {
  ...
  if (!brand) return <div className="p-8 text-sm text-zinc-500">Select a brand to view intelligence.</div>;
