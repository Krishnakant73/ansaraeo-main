...
export default async function CitationsPage() {
  ...
  if (!brand) {
    return (
      <div>
        <PageHeader title="Citations" subtitle="Which sources AI engines cite for your brand" />
        <div className="empty">
  ...
  // Bucket citations by the month of their visibility run so we can show how
  // the brand's own-domain vs third-party citation share moves over time, and
  // flag which cited domains are GROWING / STABLE / DECLINING. Never estimated —
  // months with no runs simply don't appear.
