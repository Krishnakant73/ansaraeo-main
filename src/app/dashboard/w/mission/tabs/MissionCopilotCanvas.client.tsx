...
// ============================================================
// MissionCopilotCanvas — dedicated Copilot for a mission. Same SSE
// contract; mission-scoped suggested prompts.
// ============================================================
...
const SUGGESTED = [
  ...
  "Suggest the next 2 tasks to unblock progress",
  "Summarize the verify step",
  "Is the objective still valid given current data?",
];

export default function MissionCopilotCanvas({
  missionId,
  missionTitle,
  brandName,
}: {
        ...
        body: JSON.stringify({
          ...
          context: {
            workspace: {
              ...
              id: missionId,
              label: missionTitle,
              summary: `Mission "${missionTitle}" for brand "${brandName}".`,
              hints: [
                "Answer from real tasks + approvals data only.",
                "Never invent completions, blockers, or deadlines.",
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-4">
        {messages.length === 0 && (
          <div className="space-y-3">
            <p className="text-sm text-muted">Ask anything about this mission:</p>
