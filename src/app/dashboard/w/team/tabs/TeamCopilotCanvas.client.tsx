...
const SUGGESTED = [
  "Who's on this team and what do they cover?",
  "What are our active missions right now?",
  "Where is the team under-resourced?",
  "Do we have a designated lead?",
];

export default function TeamCopilotCanvas({
  teamId,
  teamName,
  orgName,
}: {
        ...
        body: JSON.stringify({
          ...
          context: {
            workspace: {
              ...
              id: teamId,
              label: teamName,
              summary: `Team "${teamName}" in org "${orgName}".`,
              hints: [
                "Answer from the team + team_members + missions data only.",
                "Never invent members, roles, or mission ownership.",
                "Teams are org-scoped, not brand-scoped.",
              ],
            },
          },
        }),
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-4">
        {messages.length === 0 && (
          <div className="space-y-3">
            <p className="text-sm text-muted">Ask anything about this team:</p>
