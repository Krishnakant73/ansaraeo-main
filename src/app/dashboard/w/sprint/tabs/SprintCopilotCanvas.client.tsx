...
const SUGGESTED = [
  ...
  "Which missions are pulling us behind?",
  "Suggest 3 tasks to prioritize this week",
  "Summarize the burndown so far",
];

export default function SprintCopilotCanvas({
  sprintId,
  sprintName,
  brandName,
}: {
        ...
        body: JSON.stringify({
          ...
          context: {
            workspace: {
              ...
              id: sprintId,
              label: sprintName,
              summary: `Sprint "${sprintName}" for brand "${brandName}".`,
              hints: [
                "Answer from real missions + tasks + dates only.",
                "Never invent completions, timelines, or velocity numbers.",
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-4">
        {messages.length === 0 && (
          <div className="space-y-3">
            <p className="text-sm text-muted">Ask anything about {sprintName}:</p>
