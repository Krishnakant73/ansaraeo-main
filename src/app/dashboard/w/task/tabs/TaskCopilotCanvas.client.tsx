...
const SUGGESTED = [
  "What does this task need to move to done?",
  "Is anything blocking this task?",
  "Explain the engine action target in plain English.",
  "Is verification set up correctly for this task?",
];

export default function TaskCopilotCanvas({
  taskId,
  taskTitle,
  missionTitle,
  brandName,
        ...
        body: JSON.stringify({
          ...
          context: {
            workspace: {
              ...
              id: taskId,
              label: taskTitle,
              summary: `Task "${taskTitle}" inside mission "${missionTitle}" for brand ${brandName}.`,
              hints: [
                "Answer from the task row + approvals + verification_result only.",
                "Never invent progress, blockers, approvers, or engine responses.",
              ],
            },
          },
        }),
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-4">
        {messages.length === 0 && (
          <div className="space-y-3">
            <p className="text-sm text-muted">Ask anything about this task:</p>
