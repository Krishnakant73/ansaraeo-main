...
const SUGGESTED = [
  "Suggest a first-hand detail I could add",
  "Rewrite this draft in Q&A format",
  "Tighten the opening paragraph",
  "What's an original data point I could source?",
];

export default function ContentCopilotCanvas({
  contentId,
  title,
  brandName,
}: {
        ...
        body: JSON.stringify({
          ...
          context: {
            workspace: {
              ...
              id: contentId,
              label: title,
              summary: `Content draft "${title}" for brand "${brandName}".`,
              hints: [
                "Suggest edits, never invent facts.",
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-4">
        {messages.length === 0 && (
          <div className="space-y-3">
            <p className="text-sm text-muted">Ask Copilot to help edit this draft:</p>
