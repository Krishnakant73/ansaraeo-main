...
const SUGGESTED = [
  "Is this link still safe to keep live?",
  "When was it created and when does it expire?",
  "What does the recipient see when they open it?",
  "Should I revoke and issue a fresh link?",
];

export default function ShareCopilotCanvas({
  token,
  brandName,
}: {
  token: string;
        ...
        body: JSON.stringify({
          ...
          context: {
            workspace: {
              kind: "share",
              id: token,
              label: `Report link for ${brandName}`,
              summary: `Public share token for brand "${brandName}".`,
              hints: [
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-4">
        {messages.length === 0 && (
          <div className="space-y-3">
            <p className="text-sm text-muted">Ask anything about this share link:</p>
