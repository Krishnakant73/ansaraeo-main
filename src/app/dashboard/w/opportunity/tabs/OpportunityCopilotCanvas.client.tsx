...
const SUGGESTED = [
  "Explain the impact estimate in this opportunity",
  "What would the fix→verify sequence look like?",
  "Which prompt does this most affect?",
  "Is this worth accepting given our priorities?",
];

export default function OpportunityCopilotCanvas({
  opportunityId,
  title,
  brandName,
}: {
        ...
        body: JSON.stringify({
          ...
          context: {
            workspace: {
              ...
              id: opportunityId,
              label: title,
              summary: `Opportunity "${title}" for brand "${brandName}".`,
              hints: [
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-4">
        {messages.length === 0 && (
          <div className="space-y-3">
            <p className="text-sm text-muted">Ask anything about this opportunity:</p>
