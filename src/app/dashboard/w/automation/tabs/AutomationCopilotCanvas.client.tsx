...
const SUGGESTED = [
  ...
  "Suggest what could go wrong when it fires",
  "Would you tighten the trigger config?",
  "What actions should I chain after step 1?",
];

export default function AutomationCopilotCanvas({
  automationId,
  name,
  brandName,
}: {
        ...
        body: JSON.stringify({
          ...
          context: {
            workspace: {
              ...
              id: automationId,
              label: name,
              summary: `Automation "${name}" for brand "${brandName}".`,
              hints: [
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-4">
        {messages.length === 0 && (
          <div className="space-y-3">
            <p className="text-sm text-muted">Ask anything about {name}:</p>
