...
const SUGGESTED = [
  "What should I do today to improve visibility?",
  "Which competitor is winning most prompts?",
  "Summarize the last 7 days of scan results",
  "Draft 3 answer blocks for our worst-performing prompts",
];

export default function BrandCopilotCanvas({
  brandId,
  brandName,
}: {
  brandId: string;
        ...
        body: JSON.stringify({
          ...
          context: {
            workspace: {
              ...
              id: brandId,
              label: brandName,
              summary: `Brand "${brandName}" workspace.`,
              hints: [
                "Answer from real visibility_runs + citations for this brand only.",
                "Never invent competitor moves, mentions, or citations.",
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-4">
        {messages.length === 0 && (
          <div className="space-y-3">
            <p className="text-sm text-muted">Ask anything about {brandName}:</p>
